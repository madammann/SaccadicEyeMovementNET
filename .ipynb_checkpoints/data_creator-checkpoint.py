...
classes = ['airplane', 'elephant', 'apple']
...
def download(classes)
    for i in classes:
        manual_download_subgroup(i,"train",'./annotations/instances_train2014.json')

    # for creating the test data
    for i in classes:
        manual_download_subgroup(i,"test",'./annotations/instances_val2014.json')
